...
Thanks for your interest in contributing to `updater` — Pilot Protocol auto-updater sidecar — checks GitHub releases hourly, hot-swaps client binaries.

## Quick start

```bash
git clone https://github.com/pilot-protocol/updater.git
cd updater
go test -race ./...
```
